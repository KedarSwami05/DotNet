namespace ExceptionHandling
{
    internal class Program
    {
        ...
        static void Main2() //simple try block with catch
        {
            Class1 obj = new Class1();
            try
            {
        ...
        static void Main3()//try with multiple catch blocks
        {
            Class1 obj = new Class1();
            try
            {
        ...
        static void Main4()// catching base class exceptions
        {
            Class1 obj = new Class1();
            try
            {
        ...
        static void Main5()// finally block
        {
            Class1 obj = new Class1();
            try
            {
